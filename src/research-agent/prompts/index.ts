...
export const introConclusionInstructions = `You are a technical writer finishing a report on {topic}
...
Here are the sections to reflect on for writing: {formattedStringSections}`;
